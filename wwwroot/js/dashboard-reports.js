(function () {
        ...
        return `<tr data-report-id="${window.escapeHtml(report.id)}" data-report-status="${window.escapeHtml(report.status)}">
            ...
            <td class="difficulty-question-cell">
                <span class="difficulty-question-content">
                    <span class="difficulty-question-text" title="${window.escapeHtml(report.questionId)}">${window.escapeHtml(report.questionLabel || report.questionId)}</span>
    ...
    dashboard.renderProblematicQuestions = function renderProblematicQuestions(items) {
        ...
        tbody.innerHTML = items.map((q) => {
            ...
            return `<tr>
                <td class="difficulty-question-cell"><span class="difficulty-question-text" title="${window.escapeHtml(q.questionId)}">${window.escapeHtml(q.questionLabel || q.questionId)}</span></td>
