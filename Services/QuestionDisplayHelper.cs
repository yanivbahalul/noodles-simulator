...
public static class QuestionDisplayHelper
{
    private static readonly Regex ScreenshotName = new(
        @"^Screenshot at (\w{3}) (\d{1,2}) (\d{2})-(\d{2})-(\d{2})$",
        RegexOptions.IgnoreCase | RegexOptions.Compiled);

    private static readonly System.Collections.Generic.Dictionary<string, string> MonthMap =
    ...
    public static string FormatLabel(string questionId)
    {
